...
async def input_response(update: Update, context: ContextTypes.DEFAULT_TYPE) -> State:
...
async def request_title_value(update: Update, context: ContextTypes.DEFAULT_TYPE) -> State:
...
async def request_body_value(update: Update, context: ContextTypes.DEFAULT_TYPE) -> State:
...
async def request_room_choose(update: Update, context: ContextTypes.DEFAULT_TYPE) -> State:
...
async def cancel_question(update: Update, context: ContextTypes.DEFAULT_TYPE) -> State:
    await send_reply(
        update,
...
async def review_question(update: Update, context: ContextTypes.DEFAULT_TYPE) -> State:
...
async def edit_question(update: Update, context: ContextTypes.DEFAULT_TYPE) -> State:
    await send_reply(
        update,
...
async def finish_review(update: Update, context: ContextTypes.DEFAULT_TYPE) -> State:
    user_data = context.user_data
    text = update.message.text
...
async def error_fallback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    await send_reply(
        update,
