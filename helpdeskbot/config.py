...
_helpdesk_host = os.getenv("TELEGRAM_HELPDESK_WEBHOOK_HOST_URL", APP_HOST).rstrip("/")
TELEGRAM_HELP_DESK_BOT_WEBHOOK_URL = f"{_helpdesk_host}/telegram/helpdeskbot/webhook/"
TELEGRAM_HELP_DESK_BOT_WEBHOOK_HOST = "0.0.0.0"
TELEGRAM_HELP_DESK_BOT_WEBHOOK_PORT = int(os.getenv("PORT", 8817))
