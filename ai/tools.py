...
TOOLS_DESCRIPTION = [
    ...
    },
    {
        ...
        "description": "Поиск ответов на вопросы о сообществе: правилах, инструкциях, модерации, ценностях, "
                       "советах новичкам и вопросам участия",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Ключевые слова для поиска информации о сообществе"
                },
            },
            "required": ["query"],
            "additionalProperties": False
