ACHIEVEMENTS = [
    ("old", {
        "name": "Олды здесь",
        "description": "Почетный ранний участник сообщества",
        "image": "/static/images/achievements/org.png3bl.png",
        "style": "color: #FFF; background-color: #65C3BA;",
    }),
    ("investor_1000", {
        "name": "Ёрли Инвестор",
        "description": "Человек, вложивший $1000 и более реальных денег в развитие сообщества",
        "image": "/static/images/achievements/org.png3a1.png",
        "style": "background-color: #FFBE00;",
    }),
    ("parliament_member", {
        "name": "Член Парламента",
        "description": "Входит в Парламент сообщества, может влиять на новые решения, фичи и содержание главной",
        "image": "/static/images/achievements/org.png2582c2df41eb67114307e22ffee862fe923ab1843ce47781aee577cc3f2abb5f.jpg",
        "style": "background-color: #000000; font-size: 120%;",
    }),
    ("vibe_minister", {
        "name": "Министр Вайбов",
        "description": "Входит в «Министерство Вайба» сообщества",
        "image": "/static/images/achievements/vibe_minister.webp",
        "style": "background-color: #201D2E; font-size: 120%;",
    }),
    ("offline_org", {
        "name": "ОРГИ—Я",
        "description": "Организатор оффлайн ивентов сообщества",
        "image": "/static/images/achievements/offline_org.webp",
        "style": "background-color: #f41921; font-size: 140%;",
    }),
    ("contributor", {
        "name": "Контрибьютор",
        "description": "За значительный вклад в развитие сообщества",
        "image": "/static/images/achievements/org.png3ah.png",
    ...
    ("oscar", {
        ...
        "image": "/static/images/achievements/org.png3bd.png",
    ...
    ("miner", {
        ...
        "image": "/static/images/achievements/org.png3d2.png",
        "style": "background-color: #FABE0F;",
    }),
    ("helper", {
        "name": "Твой Бро",
        "description": "Пятюня за активную помощь другим участникам сообщества в интернете или в жизни",
        "image": "/static/images/achievements/org.png3bo.png",
        "style": "background-color: #4D446F;",
    }),
    ("org", {
        "name": "За Движ",
        "description": "Ачивка за организацию движух внутри сообщества",
        "image": "/static/images/achievements/org.png",
        "style": "background-color: #FF4E50; font-size: 185%;",
    }),
    ("offline", {
        "name": "За взятие офлайна",
        "description": "Медаль за участие в офлайн-сходках. "
                       "Считается любое собрание, на котором присутствовало 5 и более участников сообщества",
        "image": "/static/images/achievements/org.png3ai.png",
    ...
    ("international", {
        ...
        "image": "/static/images/achievements/org.png3aq.png",
        "style": "background-color: #1976D2; font-size: 120%;",
    }),
    ("cook", {
        "name": "Звезда Мишлен",
        "description": "Активный участник кулинарных постов",
        "image": "/static/images/achievements/org.png3c8.png",
    ...
    ("mic", {
        ...
        "image": "/static/images/achievements/mic.png",
    ...
    ("hacker_1", {
        ...
        "image": "/static/images/achievements/hack_1.png",
    ...
    ("photo_winner_2", {
        ...
        "image": "/static/images/achievements/photo_winner_2.png",
    ...
    ("photo_winner_3", {
        ...
        "image": "/static/images/achievements/photo_winner_3.png",
    ...
    ("game_tournament_org_1", {
        ...
        "image": "/static/images/achievements/game_tournament_org_1.png",
        "style": "background-color: #929292; font-size: 120%;",
    }),
    ("music_jam_6", {
        "name": "Medley",
        "description": "За участие в зимнем музыкальном челлендже 2024",
        "image": "/static/images/achievements/music_jam_6.png",
        "style": "background-color: #49D6AC; font-size: 120%;",
    }),
    ("nes_camp_2024", {
        "name": "Кэмп РЭШ 🔥 2024",
        "description": "Участник кэмпа сообщества РЭШ в 2024",
        "image": "/static/images/achievements/nes_camp_2024.jpg",
        "style": "background-color: #F1DFC5; font-size: 130%;",
    }),
    ("nes_camp_2025", {
        "name": "Кэмп РЭШ 🔥 2025",
        "description": "Участник кэмпа сообщества РЭШ в 2025",
        "image": "/static/images/achievements/nes_camp_2025.webp",
        "style": "background-color: #FF9F4B; font-size: 130%;",
    }),
    ("nes_quest_2024", {
        "name": "Золотая говнотерка",
        "description": "Призер квеста сообщества РЭШ в 2024 году",
        "image": "/static/images/achievements/nes_quest_2024.webp",
        "style": "background-color: #F1DFC5; font-size: 120%;",
    }),
    ("pokerface", {
        "name": "Покерфейс",
        "description": "Играл в покер с соклубниками",
        "image": "/static/images/achievements/pokerface.png",
        "style": "background-color: #F1DFC5; font-size: 130%;",
    }),
    ("nes_flot_2024", {
        "name": "Флот РЭШ ⛵ 2024",
        "description": "Участник флотского выезда сообщества РЭШ в 2024",
        "image": "/static/images/achievements/nes_flot_2024.png",
        "style": "background-color: #4c98d5; font-size: 120%;",
    }),
    ("nes_flot_2025", {
        "name": "Флот РЭШ ⛵ 2025",
        "description": "Участник флотского выезда сообщества РЭШ в 2025",
        "image": "/static/images/achievements/nes_flot_2025.png",
        "style": "background-color: #4c98d5; font-size: 120%;",
    }),
    ("spooky", {
        "name": "Спуки",
        "description": "За лучшие украшения на Хэллоуин",
        "image": "/static/images/achievements/spooky.png",
        "style": "background-color: #2E61F3; font-size: 130%;",
    }),
    ("ai_art", {
        "name": "AI master race",
        "description": "За участие в ИИнктобере",
        "image": "/static/images/achievements/ai_art.png",
        "style": "background-color: #132F6E; font-size: 130%;",
    }),
    ("birdwatcher", {
        "name": "Смотритель птиц",
        "description": "Ходил смотреть на птиц с клубняшами",
        "image": "/static/images/achievements/birds.png",
        "style": "background-color: #6A98FF; font-size: 130%;",
    }),
    ("couchsurfing", {
        "name": "Гроза отелей",
        "description": "За размещение у себя клубня на ночь",
        "image": "/static/images/achievements/couchsurfing.png",
    ...
    ("geoguessr_lite", {
        ...
        "image": "/static/images/achievements/geoguessr_lite.png",
    ...
    ("geoguessr_beast", {
        ...
        "image": "/static/images/achievements/geoguessr_beast.png",
    ...
    ("intellectual", {
        ...
        "image": "/static/images/achievements/intellectual.webp",
        "style": "background-color: #535D94; font-size: 110%;",
    }),
    ("nes_quest", {
        "name": "Квест РЭШ",
        "description": "Призовое место в одном из квестов сообщества",
        "image": "/static/images/achievements/nes_quest.webp",
        "style": "background-color: #006100; font-size: 130%;",
    }),
    ("nes_quiz", {
        "name": "Квизер РЭШ",
        "description": "Призовое место в одном из квизов сообщества",
        "image": "/static/images/achievements/nes_quiz.webp",
        "style": "background-color: #FF5154; font-size: 130%;",
    }),
]

# VIP: /static/images/achievements/org.png3cb.png
