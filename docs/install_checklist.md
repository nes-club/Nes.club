# Чеклист по запуску форка клубного движка

Примерный список действий, которые необходимы для запуска сайта на движке клуба
...
- [] Pepic
  ...
  - [] клонировать туда pepic (репозиторий для статических страниц)
...
- [] Оформление
  - [] Поправить главную до регистрации
  - [] Поправить описание /docs/about/
  - [] Поправить страницу связи /docs/contact/
  - [] Поправить страницу /network/
  - [] Прописать комнаты для постов
  - [] Загрузить и прописать логотип клуба
  - [] Загрузить и прописать favicon
  - [] Добавить письмо после успешной регистрации
...
- [] Проверить логи отправки писем и телеграм-ботов
...
- [] Тексты страниц в `frontend/html/docs`
